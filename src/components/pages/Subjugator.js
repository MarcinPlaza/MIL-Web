...
function renderCard(imageSrc, subName, dryWeight, thrusters, dimensions, maxThrust, maxDepth, navigation, maxSpeed, cpu, batteryLife, cameras) {
  return (
    <div className="card">
      <img src={imageSrc} className="timeline-image" alt={subName} />
...
function teamTable(data) {
  ...
  function rowMaker(data) {
    return data.map((element, index) => (
      <tr className='teamTable' key={index}>
        {dataFiller(element)}
      </tr>
    ));
  }
  ...
  return (
    <>
      <div className='center'>
        <img src="/Subjugator-Logo2.png" alt="Subjugator Logo" />
      </div>
      ...
      <p>MIL’s SubjuGator is the three-time champion autonomous submarine of the <a href="https://robosub.org/">Robosub</a> AUVSI/ONR underwater competition.</p>

      <h1>Awards</h1>
      <p>We have placed in the top 3 in eleven of the 21 years of the competition, including second place in 2012, 2013, and 2014.</p>

      <h1 >Our Submarines</h1>
      {/* Horizontal scrolling cards 
      image card and information table underneath, it is horizontally scrolling and has all our historical submarines*/}
    ...
    <h1>Team</h1>
    {teamTable([
      //array of team members and information
      //format ['name', 'position', 'subteam', 'email']
